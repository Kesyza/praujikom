...
<div class="col-xl-3 col-md-6 mb-4">
    <a href="{{route('manufacture.index')}}" style="text-decoration:none;">
    <div class="card border-left-danger shadow-sm h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Merek Tersedia</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ DB::table('manufactures')->count() }}</div>
                </div>
                <div class="col-auto">
...
<div class="col-xl-3 col-md-6 mb-4">
    ...
    <div class="card border-left-danger shadow-sm h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Pelanggan</div>
