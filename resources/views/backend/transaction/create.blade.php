            ...
            $('.new_customer').append(
                '<div class="row">'+
                    '<div class="col">'+
                        '<div class="form-group">'+
                          '<label>NIK</label>'+
                          '<input type="number" name="nik" id="" class="form-control border-dark-50" required="">'+
                        '</div>'+
                    '</div>'+
                    '<div class="col">'+
                        '<div class="form-group">'+
                ...
                '<div class="row">'+
                    '<div class="col">'+
                        '<div class="form-group">'+
                          '<label>Alamat</label>'+
                          '<textarea type="text" name="address" id="" class="form-control border-dark-50" required=""></textarea>'+
                        '</div>'+
                    '</div>'+
                    '<div class="col">'+
                        '<div class="form-group">'+
