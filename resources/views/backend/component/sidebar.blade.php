...
<ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-left justify-content-left" href="{{route('dashboard')}}">
    ...
    <li class="nav-item">
        ...
        <div id="car" class="collapse {{active(['car.index','manufacture.index'],'show')}}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            ...
            <a class="collapse-item {{active('manufacture.index')}}" href="{{route('manufacture.index')}}">Data Merek</a>
            </div>
        </div>
    </li>
